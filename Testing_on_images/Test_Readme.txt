...
Note: This code has been developed keeping in mind a Linux system. So, all the folders have a forward slash in their paths in the code. If you plan to execute on Windows, you have to manually change the forward slashes to backward slashes in the code.