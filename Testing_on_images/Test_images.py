...
#   If you want to get your output with the overlay of the original image, please uncomment this portion. 
#   Or else, don't modify. 
...
#     image = Image.fromarray(image)
    ...
    plt.close(fig)
    print('\rImage Segmented:', j, end='')
print("Output generated for all the images")